...
meu app desktop (Electron + React + TS) que reorganiza o diff de uma PR em fatia vertical
(feature → camada). O objetivo final é conseguir escrever, sozinho e com confiança, todo o
código TypeScript do app: das funções puras de domínio à UI tipada em React.
...
- Entendo a fronteira Electron tipada: o contrato IPC main↔renderer como tipos compartilhados.
...
- Empacotamento/assinatura/auto-update do Electron (fora até da v1 do PRD).
